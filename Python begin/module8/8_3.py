...
for every_second in range(reverse_timer,-1,-1):
    if every_second == 0:
        print("Ваша еда готова, осторожно горячo!")
        break
    print(f"Осталось секунд: {every_second}")
    current_choice = int(input("Еда готова? "))
    if current_choice == 1:
        print(f"Ваша еда готова, можете забрать. Время разогрева секунд {every_second}")
        break
